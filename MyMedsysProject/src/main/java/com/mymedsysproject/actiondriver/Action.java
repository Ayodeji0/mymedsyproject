 ...
 * 
 */
package com.mymedsysproject.actiondriver;
...
public class Action extends BaseClass  {
	...
	public boolean switchToFrameByIndex(WebDriver driver, int index) {
	    try {
	        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(index));
	        WebElement frameElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//iframe)[" + (index + 1) + "]")));
	...
	public String takeScreenshot(WebDriver driver, String filename) {
	    try {
	        ...
	        String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(currentDate);
	        ...
	        e.printStackTrace();
	        return null; // Return null to indicate that the screenshot capture failed
	    }
	}
	
	public static String getCurrentTime() {
	    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-hhmmss");
	    String currentDate = dateFormat.format(new Date(0));
	    return currentDate;
	}
	 ...
	 * @return
	 */
	public static boolean isDisplayed(ThreadLocal<WebDriver> driver, WebElement logo) {
